    ...
    <>
      ...
      {open && minimized && (
        <button
          ...
          className="fixed right-4 bottom-24 z-50 flex items-center gap-2 rounded-xl border border-primary/30 bg-background/95 px-4 py-2 text-sm font-semibold shadow-2xl backdrop-blur-xl sm:right-6"
        >
      ...
      <button
        ...
        className="fixed right-4 bottom-5 z-50 flex size-14 items-center justify-center rounded-full border border-primary/40 bg-primary text-primary-foreground shadow-[0_0_28px_oklch(0.72_0.2_148/0.35)] transition-transform hover:scale-105 sm:right-6"
